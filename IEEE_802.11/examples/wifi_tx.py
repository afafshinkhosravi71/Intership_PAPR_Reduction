...
# Title: Wifi transmetter
# Author: http://www.ccs-labs.org/projects/wime/
# Description: Wifi transmetter IEEE 802.11
# Generated: Wed May 17 11:37:27 2017
##################################################
...
class wifi_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Wifi transmetter")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Wifi transmetter")
        ...
        self.freq = freq = 2452000000
        self.encoding = encoding = 0

        ##################################################
        # Blocks
        ##################################################
        self._tx_gain_range = Range(0, 1, 0.01, 0, 200)
        ...
        self.qtgui_time_sink_x_1_1 = qtgui.time_sink_c(
        	10000, #size
        	samp_rate, #samp_rate
        	"Time Scope Complex", #name
        	1 #number of inputs
        )
        self.qtgui_time_sink_x_1_1.set_update_time(0.10)
        self.qtgui_time_sink_x_1_1.set_y_axis(-3, 3)
        ...
        self.foo_packet_pad2_0 = foo.packet_pad2(False, False, 0.01, 3000, 3000)
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/herve/Documents/Script_GNURadio/IEEE_802.11/gr-ieee802-11/examples/Data_File/file_c', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, '/home/herve/Documents/Script_GNURadio/IEEE_802.11/gr-ieee802-11/examples/Data_File/file_e', False)
        ...
        self.connect((self.foo_packet_pad2_0, 0), (self.qtgui_time_sink_x_1_1, 0))
        ...
        self.connect((self.wifi_phy_hier_0, 0), (self.qtgui_freq_sink_x_0, 0))
