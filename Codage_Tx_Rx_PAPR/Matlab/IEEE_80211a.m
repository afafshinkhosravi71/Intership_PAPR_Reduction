...
figure()
plot((1:length(Sg_final))/sampleRate, abs(Sg_final))
hold on;
plot((1:length(Sg_final_clp))/sampleRate, abs(Sg_final_clp))
...
plot((1:length(Sg_final))/sampleRate, abs(Sg_final))
hold on;
plot((1:length(Sg_final_TR))/sampleRate, abs(Sg_final_TR))
hold off;
