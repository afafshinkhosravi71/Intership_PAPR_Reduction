...
# Title: Vv017 Paprtr
# Generated: Wed Apr 26 08:56:04 2017
##################################################
...
class vv017_paprtr(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Vv017 Paprtr")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Vv017 Paprtr")
        ...
        self.settings = Qt.QSettings("GNU Radio", "vv017_paprtr")
        ...
        self.dtv_dvbt2_pilotgenerator_cc_0 = dtv.dvbt2_pilotgenerator_cc(dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K, dtv.PILOT_PP4, dtv.GI_1_32, 19, dtv.PAPR_TR, dtv.VERSION_111, dtv.PREAMBLE_T2_SISO, dtv.MISO_TX1, dtv.EQUALIZATION_OFF, dtv.BANDWIDTH_8_0_MHZ, 32768)
        self.dtv_dvbt2_paprtr_cc_0 = dtv.dvbt2_paprtr_cc(dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K, dtv.PILOT_PP4, dtv.GI_1_32, 19, dtv.PAPR_TR, dtv.VERSION_111, 3.05, 9, 32768)
        self.dtv_dvbt2_p1insertion_cc_0 = dtv.dvbt2_p1insertion_cc(dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K, dtv.GI_1_32, 19, dtv.PREAMBLE_T2_SISO, dtv.SHOWLEVELS_OFF, 3.3)
        ...
        self.dtv_dvbt2_freqinterleaver_cc_0 = dtv.dvbt2_freqinterleaver_cc(dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K, dtv.PILOT_PP4, dtv.GI_1_32, 19, dtv.PAPR_TR, dtv.VERSION_111, dtv.PREAMBLE_T2_SISO)
        self.dtv_dvbt2_framemapper_cc_0 = dtv.dvbt2_framemapper_cc(dtv.FECFRAME_NORMAL, dtv.C4_5, dtv.MOD_256QAM, dtv.ROTATION_ON, 64, 1, dtv.CARRIERS_EXTENDED, dtv.FFTSIZE_32K, dtv.GI_1_32, dtv.L1_MOD_64QAM, dtv.PILOT_PP4, 2, 19, dtv.PAPR_TR, dtv.VERSION_111, dtv.PREAMBLE_T2_SISO, dtv.INPUTMODE_NORMAL, dtv.RESERVED_OFF, dtv.L1_SCRAMBLED_OFF, dtv.INBAND_OFF)
        self.dtv_dvbt2_cellinterleaver_cc_0 = dtv.dvbt2_cellinterleaver_cc(dtv.FECFRAME_NORMAL, dtv.MOD_256QAM, 64, 1)
        ...
        self.dtv_dvb_bbheader_bb_0 = dtv.dvb_bbheader_bb(dtv.STANDARD_DVBT2, dtv.FECFRAME_NORMAL, dtv.C4_5, dtv.RO_0_35, dtv.INPUTMODE_HIEFF, dtv.INBAND_OFF, 168, 4000000)
        self.digital_ofdm_cyclic_prefixer_0 = digital.ofdm_cyclic_prefixer(32768, 32768+32768 / 32, 0, '')
        ...
        self.connect((self.dtv_dvbt2_paprtr_cc_0, 0), (self.digital_ofdm_cyclic_prefixer_0, 0))
        self.connect((self.dtv_dvbt2_pilotgenerator_cc_0, 0), (self.dtv_dvbt2_paprtr_cc_0, 0))
...
def main(top_block_cls=vv017_paprtr, options=None):
