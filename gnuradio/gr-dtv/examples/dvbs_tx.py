...
# Title: Dvbs Tx
# Generated: Wed May  3 15:12:19 2017
##################################################
...
class dvbs_tx(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Dvbs Tx")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Dvbs Tx")
        ...
        self.settings = Qt.QSettings("GNU Radio", "dvbs_tx")
        self.restoreGeometry(self.settings.value("geometry").toByteArray())

        ##################################################
        # Variables
        ##################################################
        self.symbol_rate = symbol_rate = 8000000
        ...
        self.dtv_dvbt_inner_coder_0 = dtv.dvbt_inner_coder(1, 1512, dtv.MOD_QPSK, dtv.NH, dtv.C7_8)
        ...
        dtv.C1_4, dtv.MOD_QPSK, dtv.INTERPOLATION_ON)
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_char*1, 1512)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/herve/Documents/Script_GNURadio/vv017-paprtr.ts', True)
